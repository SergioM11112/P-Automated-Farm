...
### Datos que soportan del Problema

El sector agropecuario ha sido uno de los principales contribuyentes en el desarrollo económico, social y productivo del país en los últimos años. Pues, según cifras  mencionadas por parte del Ministerio de Agricultura, las unidades productivas de este sector son las encargadas de generar alrededor del 67% de la producción de alimentos del país. Así mismo, a través de los procesos requeridos para el desarrollo de cada una de las actividades económicas asociadas al sector, se está favoreciendo la empleabilidad en el sector agrícola (aproximadamente un 77%). Estos datos se complementan gracias al estudio llevado a cabo por la revista “Statista Research Departament” donde se hace la comparación entre el porcentaje representativo del sector agropecuario en el PIB de la nación a lo largo de los años (desde el 2007-2021), llegando a incrementar en el año 2021 un 18% respecto al año anterior. 

Esta información refleja el grado de valor que tiene asociada la agricultura en el contexto económico de la nación, sin embargo estas cifras se han ido agravando poco a poco debido a los diversas problemáticas a las que se ha tenido que enfrentar la población campesina (quienes hacen producir la tierra), pues debido a los inconvenientes presentados en los últimos años con los grupos armados de ciertas regiones del país, la falta de recursos tecnológicos para fomentar la competitividad en los sectores y el alza en los precios de diversos productos esenciales para la producción de los alimentos, la realidad campesina  no ha proyectado un panorama muy alentador para su futuro. 

Esto se justifíca basándonos en lo mencionado por CODHES pues, para el año 2019, alrededor de 5.921.924 personas tuvieron que movilizarse a otros municipios o ciudades debido a la falta de seguridad y estabilidad en sus lugares de procedencia, siendo este número un indicador alarmante pues debido a esto la productividad en el sector agropecuario se ha visto afectada. 
...
## Posibles soluciones
Con el fin de fortalecer la industria en las zonas rurales se pretende brindar a los campesinos de herramientas tecnológicas relativamente económicas que permitan automatizar muchos de los procesos necesarios  para continuar con su nivel de producción normal tanto en el sector agrícola como en el agropecuario, estas soluciones pueden ser:
### Sector Agrícola
+ Sistema de refrigeración o calefacción para los cultivos que se activa después de superar unos límites en las mediciones de los sensores de temperatura.
+ Rociadores para la tierra que se activan cuando detectan que la humedad de la tierra no es adecuada para el crecimiento de los cultivos.
+ Medidores de nutrientes presentes en la tierra que arrojen una alarma o una señal al agricultor cuando detecte una deficiencia en algún nutriente (nitrógeno, fósforo, potasio, etc).
### Sector Agropecuario
+ Dosificador inteligente de alimento para animales.
+ Sistema que por medio de una alarma y una puerta con cierre automático permite resguardar a los animales en el establo ante las inclemencias del tiempo o al final del día.
+ Monitores que rastreen la ubicación, alimentación, celo o el estado de salud de los animales y que su información sea accesible en todo momento para el campesino.

## Objetivos
 ### Principal
 + Elaborar el prototipo de una granja ganadera semi-automática que permita resguardar a los animales en el establo ante las variaciones drásticas del clima  que además posea un dispensador de comida.
 ### Secundarios
 + Utilizar al menos dos periféricos de entrada y de salida para desarrollar el prototipo de la granja.
 + Aplicar los conocimientos de electrónica digital adquiridos en el transcurso del semestre para desarrollar y presentar el proyecto final de la asignatura.

## Defina los actores de la solución y sus roles
